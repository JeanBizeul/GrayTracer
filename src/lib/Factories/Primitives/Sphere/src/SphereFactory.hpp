...
#ifndef SRC_LIB_FACTORIES_PRIMITIVES_SPHERE_SRC_SPHEREFACTORY_HPP_
#define SRC_LIB_FACTORIES_PRIMITIVES_SPHERE_SRC_SPHEREFACTORY_HPP_
#include <memory>
#include <string>
...
#endif  // SRC_LIB_FACTORIES_PRIMITIVES_SPHERE_SRC_SPHEREFACTORY_HPP_
